...
import 'package:rentease/Admin.dart';
  ...
  Future<void> getUserData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (user != null) {
          if(user['email']=='admin@rentease.com'&&user['pass']=='admin123'){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>admin()));
          }
          else {
              Navigator.push(context, MaterialPageRoute(builder: (context) => HomeScreen(email: emails.text, password: passwords.text)));
          }
        } else {
